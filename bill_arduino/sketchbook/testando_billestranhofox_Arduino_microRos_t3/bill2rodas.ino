...
//roda_Traseira
//Left wheel
int8_t roda_Traseira_L_FORW;
int8_t roda_Traseira_L_BACK;
int8_t roda_Traseira_L_enablePin;
int8_t roda_Traseira_L_encoderPin1;  //Encoder Output of pin1 must connected with intreput pin of Esp32.
int8_t roda_Traseira_L_encoderPin2;

//Right wheel
int8_t roda_Traseira_R_FORW;
int8_t roda_Traseira_R_BACK;
int8_t roda_Traseira_R_enablePin;
int8_t roda_Traseira_R_encoderPin1;  //Encoder Output of pin1 must connected with intreput pin of Esp32.
int8_t roda_Traseira_R_encoderPin2;
...
int threshold = 200; //200; //200; //165; //120; //0; //180; //100; //50; //150; //default = 0;
//testar com 200 
