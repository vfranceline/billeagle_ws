...
#ifndef BILL_INTERFACES__SRV__DETAIL__GET_NAME__FUNCTIONS_H_
#define BILL_INTERFACES__SRV__DETAIL__GET_NAME__FUNCTIONS_H_
...
/// Initialize srv/GetName message.
/**
...
/// Create srv/GetName message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * bill_interfaces__srv__GetName_Request__init().
...
/// Destroy srv/GetName message.
/**
 * It calls
 * bill_interfaces__srv__GetName_Request__fini()
...
/// Check for srv/GetName message equality.
/**
...
/// Initialize array of srv/GetName messages.
/**
...
/// Finalize array of srv/GetName messages.
/**
 * It calls
 * bill_interfaces__srv__GetName_Request__fini()
...
/// Create array of srv/GetName messages.
/**
 * It allocates the memory for the array and calls
 * bill_interfaces__srv__GetName_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetName messages.
/**
 * It calls
 * bill_interfaces__srv__GetName_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetName message array equality.
/**
...
/// Copy an array of srv/GetName messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * bill_interfaces__srv__GetName_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_bill_interfaces
...
/**
 * It calls
 * bill_interfaces__srv__GetName_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_bill_interfaces
...
/**
 * It allocates the memory for the array and calls
 * bill_interfaces__srv__GetName_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_bill_interfaces
...
/**
 * It calls
 * bill_interfaces__srv__GetName_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BILL_INTERFACES__SRV__DETAIL__GET_NAME__FUNCTIONS_H_
