...
#include "bill_interfaces/srv/detail/execute_spin__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bill_interfaces::srv::ExecuteSpin_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const bill_interfaces::srv::ExecuteSpin_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<bill_interfaces::srv::ExecuteSpin_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ExecuteSpin_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const bill_interfaces::srv::ExecuteSpin_Request *>(
...
static size_t _ExecuteSpin_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ExecuteSpin_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ExecuteSpin_Request__callbacks = {
  "bill_interfaces::srv",
  "ExecuteSpin_Request",
...
static rosidl_message_type_support_t _ExecuteSpin_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ExecuteSpin_Request__callbacks,
...
{
  return &bill_interfaces::srv::typesupport_fastrtps_cpp::_ExecuteSpin_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = bill_interfaces::srv::ExecuteSpin_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const bill_interfaces::srv::ExecuteSpin_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<bill_interfaces::srv::ExecuteSpin_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ExecuteSpin_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const bill_interfaces::srv::ExecuteSpin_Response *>(
...
static size_t _ExecuteSpin_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ExecuteSpin_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ExecuteSpin_Response__callbacks = {
  "bill_interfaces::srv",
...
static rosidl_message_type_support_t _ExecuteSpin_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ExecuteSpin_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &bill_interfaces::srv::typesupport_fastrtps_cpp::_ExecuteSpin_Response__handle;
}
...
static service_type_support_callbacks_t _ExecuteSpin__callbacks = {
  "bill_interfaces::srv",
  "ExecuteSpin",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bill_interfaces, srv, ExecuteSpin_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bill_interfaces, srv, ExecuteSpin_Response)(),
...
static rosidl_service_type_support_t _ExecuteSpin__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ExecuteSpin__callbacks,
...
{
  return &bill_interfaces::srv::typesupport_fastrtps_cpp::_ExecuteSpin__handle;
}
